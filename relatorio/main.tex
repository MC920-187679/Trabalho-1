...
\begin{document}
    ...
    % Além disso, as funções puderam ser vetorizadas facilmente, no geral. A única exceção foi a operação de mosaico (\cref{sec:mosaico}), que foi implementado com alguns laços explícitos sobre os blocos da imagem.
